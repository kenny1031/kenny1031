...
Building end-to-end ML systems and computer vision projects.
...
## 🧰 Tech Stack
**ML / Retrieval / CV:** Python, PyTorch, scikit-learn, XGBoost, Sentence Transformers, FiftyOne  
**Backend / Data:** FastAPI, PostgreSQL, SQLAlchemy, SQL, Docker, Git  
**Also used:** C, Java, R, TypeScript, React

## 📌 What I'm focusing on now
- Building production-style ML systems and full-stack AI applications
- Interested in machine learning, search/retrieval, ranking, computer vision, and backend engineering
